export default function Hero() {
    return (
        ...
        <ol className="benefits-list">
            ...
            <li>Learn more about the gym, training and techniques!</li> 
        ...
        <div className="rule-item">
            <p><b>Reps</b></p>
            <p>Every rep is a pause rep following <abbr title="2 seconds down - 2 seconds pause - 2 second up">a 2 - 2 - 2 tempo</abbr></p>
        </div>
        <div className="rule-item">
            <p><b>Weight*</b></p>
